    ...
    <body>
        ...
        <ul class="nav justify-content-end mt-3">
            @if (Route::has('login'))
                ...
                @else
                    <li class="nav-item">
                        <a href="{{ route('login') }}" class="btn btn-outline-secondary m-2">Login</a>
                    </li>
        ...
        <div class="d-flex flex-column align-items-center justify-content-center" style="height: 60vh;">
            <img src="{{ asset('images/cellar-vinhos.png') }}" class="img-fluid" width="450px">
        </div>
